  ...
  return (
    ...
    >
      <Link to={`/dashboard/resume/${resume.documentId}/edit`}>
        <div 
          className="h-48 bg-gradient-to-br from-orange-600 to-yellow-200 flex items-center justify-center"
          style={{
      ...
      <div 
        className="p-3 flex justify-between items-center bg-purple-200 border-t border-gray-100"
        style={{
